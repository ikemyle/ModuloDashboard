...
namespace Modulo.Dashboard.ViewModels
{
    ...
    public class SettingsAppearanceViewModel : BindableBase
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.SelectedFontSize = AppearanceManager.Current.FontSize == FontSize.Large ? ThemeFont.FontLarge : ThemeFont.FontSmall;
            SyncThemeAndColor();
        ...
        {
            get { return new string[] { ThemeFont.FontSmall, ThemeFont.FontLarge }; }
        }
        ...
        public Link SelectedTheme
        {
            ...
            set
            {
                if (this.selectedTheme != value)
                {
                    ...
                    UiAppSetting.CurrentUserSettings.UISetting.theme = value.Source.OriginalString;
                    UiAppSetting.SaveSetting();
                }
            }
        }
        ...
        public string SelectedFontSize
        {
            ...
            set
            {
                if (this.selectedFontSize != value)
                {
                    ...
                    UiAppSetting.CurrentUserSettings.UISetting.fontsize = value;
                    UiAppSetting.SaveSetting();
                }
            }
        }
        ...
        public Color SelectedAccentColor
        {
            ...
            set
            {
                if (this.selectedAccentColor != value)
                {
                    ...
                    UiAppSetting.CurrentUserSettings.UISetting.accentcolor = value.ToString();
                    UiAppSetting.SaveSetting();
                }
            }
        }
