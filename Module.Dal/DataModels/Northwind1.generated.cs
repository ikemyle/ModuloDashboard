...
namespace NW.DataModels
{
	/// <summary>
	/// Database       : NORTHWND
	/// Data Source    : WIN-CTN5OEM84J2\LMNY
	...
	public partial class NORTHWNDDB : LinqToDB.Data.DataConnection
	{
		...
		public ITable<EmployeeAmerica>            EmployeeAmericas             { get { return this.GetTable<EmployeeAmerica>(); } }
		public ITable<EmployeeAsia>               EmployeeAsias                { get { return this.GetTable<EmployeeAsia>(); } }
		...
		public NORTHWNDDB(DataOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public NORTHWNDDB(DataOptions<NORTHWNDDB> options)
	...
	[Table(Schema="dbo", Name="employee_america")]
	public partial class EmployeeAmerica
	{
		[Column("employee_id"), PrimaryKey,  NotNull] public int       EmployeeId { get; set; } // int
		[Column("sale_amount"),              NotNull] public decimal   SaleAmount { get; set; } // numeric(18, 0)
		[Column("sales_date"),     Nullable         ] public DateTime? SalesDate  { get; set; } // datetime
	}

	[Table(Schema="dbo", Name="employee_asia")]
	public partial class EmployeeAsia
	{
		[Column("employee_id"), PrimaryKey,  NotNull] public int       EmployeeId { get; set; } // int
		[Column("sale_amount"),              NotNull] public decimal   SaleAmount { get; set; } // numeric(18, 0)
		[Column("sales_date"),     Nullable         ] public DateTime? SalesDate  { get; set; } // datetime
	...
	public static partial class NORTHWNDDBStoredProcedures
	{
		#region CustOrderHist

		public static IEnumerable<CustOrderHistResult> CustOrderHist(this NORTHWNDDB dataConnection, string @CustomerID)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<CustOrdersDetailResult> CustOrdersDetail(this NORTHWNDDB dataConnection, int? @OrderID)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<CustOrdersOrdersResult> CustOrdersOrders(this NORTHWNDDB dataConnection, string @CustomerID)
		{
			var parameters = new []
			{
				new DataParameter("@CustomerID", @CustomerID, LinqToDB.DataType.NChar)
		...
		public static IEnumerable<EmployeeSalesByCountryResult> EmployeeSalesByCountry(this NORTHWNDDB dataConnection, DateTime? @BeginningDate, DateTime? @EndingDate)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<SalesByCategoryResult> SalesByCategory(this NORTHWNDDB dataConnection, string @CategoryName, string @OrdYear)
		{
			var parameters = new []
			{
		...
		public static IEnumerable<SalesByYearResult> SalesByYear(this NORTHWNDDB dataConnection, DateTime? @BeginningDate, DateTime? @EndingDate)
		{
			var parameters = new []
			{
				new DataParameter("@Beginning_Date", @BeginningDate, LinqToDB.DataType.DateTime),
		...
		public static int SpAlterdiagram(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId, int? @version, byte[] @definition)
		{
			var parameters = new []
			{
		...
		public static int SpCreatediagram(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId, int? @version, byte[] @definition)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static int SpDropdiagram(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<SpHelpdiagramdefinitionResult> SpHelpdiagramdefinition(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<SpHelpdiagramsResult> SpHelpdiagrams(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname", @diagramname, LinqToDB.DataType.NVarChar)
		...
		public static int SpRenamediagram(this NORTHWNDDB dataConnection, string @diagramname, int? @ownerId, string @newDiagramname)
		{
			var parameters = new []
			{
				new DataParameter("@diagramname",     @diagramname,    LinqToDB.DataType.NVarChar)
		...
		public static IEnumerable<TenMostExpensiveProductsResult> TenMostExpensiveProducts(this NORTHWNDDB dataConnection)
		{
	...
	public static partial class TableExtensions
	{
		...
		public static EmployeeAmerica Find(this ITable<EmployeeAmerica> table, int EmployeeId)
		{
			return table.FirstOrDefault(t =>
				t.EmployeeId == EmployeeId);
		}

		public static EmployeeAsia Find(this ITable<EmployeeAsia> table, int EmployeeId)
		{
			return table.FirstOrDefault(t =>
				t.EmployeeId == EmployeeId);
		}
